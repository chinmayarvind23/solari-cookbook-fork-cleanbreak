...
The separately recorded live validation used ${results.liveValidation.model ?? "no available model"}
on the ${results.liveValidation.scenario ?? "unavailable"} scenario and returned
${results.liveValidation.verificationResult ?? "no result"}; it is not counted as a
