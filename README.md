...
Milestone 7 benchmarks the production policy, persistence, approval, commit,
verification, and receipt layers through isolated deterministic adapters. It
does not claim production success across real subscription providers.
